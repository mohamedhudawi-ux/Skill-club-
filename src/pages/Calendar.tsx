...
export default function Calendar() {
  ...
  return (
    <div className="space-y-12">
      <div>
        <h2 className="text-3xl font-black text-stone-900">Union Calendar</h2>
        <p className="text-stone-500">Stay updated with the latest events and programs from SAFA.</p>
      </div>
        ...
        <div key={month} className="space-y-6">
          ...
          <div className="grid gap-4">
            {(monthPrograms as Program[]).map((program) => (
              <div key={program.id} className="bg-white p-6 rounded-3xl shadow-sm border border-stone-100 flex flex-col sm:flex-row sm:items-center gap-6 hover:shadow-md transition-all group">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-stone-500 text-sm mb-4 leading-relaxed">{program.description || 'Join us for this exciting program organized by SAFA Students Union.'}</p>
